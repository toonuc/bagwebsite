            ...
            <div className="flex flex-col md:flex-row justify-between text-left bg-black/70 md:p-24 p-10 md:space-x-8">
                <section className="flex flex-col md:w-1/2 w-full">
                    <div className="flex flex-col">
                        <h2 className="font-pacifico text-white text-s3 lg:text-s2 underline underline-offset-8">Our Collections</h2>
                        <p className="font-pacifico text-white text-s4 lg:text-s3">Choose the right bags for your style.</p>
                        <div className="w-auto flex justify-end mt-2">
                            <img className="w-52 hidden lg:block" src="https://drive.google.com/uc?export=view&id=1-Z4uv2oLt80Jcu0ROsJhDF0HorxhyZ3H" alt="" />
                        </div>
                    </div>
                    <section className="flex-row space-x-6 relative group hidden md:flex mt-10 mr-auto">
                        <div>
                            <img src={slides[firstPic].url} alt="" className="w-60" />
                        </div>
                        <div>
                            <img src={slides[secondPic].url} alt="" className="w-60" />
                        </div>
                        <div className='hidden lg:block'>
                            <img src={slides[thirdPic].url} alt="" className="w-60" />
                        </div>
                        {/* ARROWS */}
                ...
                <div className="md:w-1/2 w-auto aspect-square"><img src="https://drive.google.com/uc?export=view&id=1ZJ4bzJg6AZjTr9J6Z3r-5yhj3sbwm9U5" alt="" /></div>
                {/* COLLAPSED SLIDER */}
